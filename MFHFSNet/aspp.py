...
class ASPP(nn.Module):
    def __init__(self, inplanes, planes, output_stride, BatchNorm):
...
def build_aspp(inplanes, planes, output_stride, BatchNorm):
    return ASPP(inplanes, planes, output_stride, BatchNorm)